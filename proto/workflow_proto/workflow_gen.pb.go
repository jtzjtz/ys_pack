...
type Query struct {
	...
	Db DB `protobuf:"varint,5,opt,name=db,proto3,enum=workflow_proto.DB" json:"db,omitempty"`
...
func init() {
	proto.RegisterEnum("workflow_proto.DB", DB_name, DB_value)
	proto.RegisterType((*Workflow)(nil), "workflow_proto.Workflow")
	proto.RegisterType((*Result)(nil), "workflow_proto.Result")
	proto.RegisterType((*UpdateAndCondition)(nil), "workflow_proto.UpdateAndCondition")
	proto.RegisterType((*Query)(nil), "workflow_proto.Query")
	proto.RegisterMapType((map[string]string)(nil), "workflow_proto.Query.OrderByEntry")
	proto.RegisterType((*PageQuery)(nil), "workflow_proto.PageQuery")
	proto.RegisterType((*EntityResult)(nil), "workflow_proto.EntityResult")
	proto.RegisterType((*ListResult)(nil), "workflow_proto.ListResult")
	proto.RegisterType((*PageResult)(nil), "workflow_proto.PageResult")
	proto.RegisterType((*WorkflowPageData)(nil), "workflow_proto.WorkflowPageData")
}
...
var fileDescriptor_b4957b17e3da92c2 = []byte{
	...
	,
}
...
func (c *workflowServiceClient) CreateWorkflow(ctx context.Context, in *Workflow, opts ...grpc.CallOption) (*EntityResult, error) {
	...
	err := c.cc.Invoke(ctx, "/workflow_proto.WorkflowService/CreateWorkflow", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *workflowServiceClient) UpdateWorkflow(ctx context.Context, in *UpdateAndCondition, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
	err := c.cc.Invoke(ctx, "/workflow_proto.WorkflowService/UpdateWorkflow", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *workflowServiceClient) GetWorkflow(ctx context.Context, in *Query, opts ...grpc.CallOption) (*EntityResult, error) {
	out := new(EntityResult)
	err := c.cc.Invoke(ctx, "/workflow_proto.WorkflowService/GetWorkflow", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *workflowServiceClient) GetWorkflowList(ctx context.Context, in *Query, opts ...grpc.CallOption) (*ListResult, error) {
	out := new(ListResult)
	err := c.cc.Invoke(ctx, "/workflow_proto.WorkflowService/GetWorkflowList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *workflowServiceClient) DeleteWorkflow(ctx context.Context, in *Query, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
	err := c.cc.Invoke(ctx, "/workflow_proto.WorkflowService/DeleteWorkflow", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *workflowServiceClient) GetWorkflowPageList(ctx context.Context, in *PageQuery, opts ...grpc.CallOption) (*PageResult, error) {
	out := new(PageResult)
	err := c.cc.Invoke(ctx, "/workflow_proto.WorkflowService/GetWorkflowPageList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *workflowServiceClient) GetWorkflowCount(ctx context.Context, in *Query, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
	err := c.cc.Invoke(ctx, "/workflow_proto.WorkflowService/GetWorkflowCount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _WorkflowService_CreateWorkflow_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/workflow_proto.WorkflowService/CreateWorkflow",
	}
...
func _WorkflowService_UpdateWorkflow_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/workflow_proto.WorkflowService/UpdateWorkflow",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _WorkflowService_GetWorkflow_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/workflow_proto.WorkflowService/GetWorkflow",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _WorkflowService_GetWorkflowList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/workflow_proto.WorkflowService/GetWorkflowList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _WorkflowService_DeleteWorkflow_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/workflow_proto.WorkflowService/DeleteWorkflow",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _WorkflowService_GetWorkflowPageList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/workflow_proto.WorkflowService/GetWorkflowPageList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _WorkflowService_GetWorkflowCount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/workflow_proto.WorkflowService/GetWorkflowCount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _WorkflowService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "workflow_proto.WorkflowService",
